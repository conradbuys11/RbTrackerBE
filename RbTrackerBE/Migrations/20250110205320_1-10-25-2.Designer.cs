...
namespace RbTrackerBE.Migrations
{
    ...
    [Migration("20250110205320_1-10-25-2")]
    partial class _110252
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RbTrackerBE.Models.TeamInYear", b =>
                {
                    ...
                    b.Property<string>("LikelyRecord")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("RbTrackerBE.Models.Game", b =>
                {
                    b.HasOne("RbTrackerBE.Models.TeamInYear", "LikelyWinner")
                        .WithMany()
                        .HasForeignKey("LikelyWinnerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RbTrackerBE.Models.TeamInYear", "Loser")
                        .WithMany()
                    ...
                    b.HasOne("RbTrackerBE.Models.TeamInYear", "Winner")
                        .WithMany()
                        .HasForeignKey("WinnerId");

                    b.Navigation("LikelyWinner");
